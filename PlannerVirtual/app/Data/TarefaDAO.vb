        ...
        Catch ex As TarefaNaoEncontradaException
            Using cn = New SQLiteConnection(sConnectionString)
                ...
                Using objCommand As SQLiteCommand = cn.CreateCommand()
                    objCommand.CommandText = "INSERT INTO Tarefas (descricao, horarioInicio, duracao, estado, categoria) VALUES ('" & tarefa.descricao & "','" & tarefa.horarioInicio & "','" & tarefa.duracao & "','" & tarefa.estado & "','" & tarefa.categoria & "')"
